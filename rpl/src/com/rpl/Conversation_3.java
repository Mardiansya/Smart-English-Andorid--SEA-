...
public class Conversation_3 extends Activity implements OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.conversation_3);
	...
	private void playSound(int arg) {
		if (arg == 1) {
			...
			player = MediaPlayer.create(this, R.raw.e2);
		}
	...
	public void koreksi(){
		if(pilihan.getCheckedRadioButtonId() == R.id.radio3){
			...
			jawaban.setText("The Answer: Another Person");
		} else {
	...
	public void koreksi2(){
		if(pilihan2.getCheckedRadioButtonId() == R.id.radio6){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban2.setText("The Answer: Well, I can't");
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
	...
	public void koreksi3(){
		...
		if(inputJawaban.equals(jawabanUser)){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban3.setText("The Answer: type");			
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
