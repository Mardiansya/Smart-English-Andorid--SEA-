...
public class Tab_reading1 extends TabActivity {
	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.tab_reading1);
		...
		Intent textIntent = new Intent(this,Tab_read1_text.class);
		...
		Intent soalIntent = new Intent(this, Tab_read1_soal.class);
		...
		Intent bahasIntent = new Intent(this, Tab_read1_bahas.class);
