...
public class Conversation_5 extends Activity implements OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.conversation_5);
	...
	public void koreksi(){
		if(pilihan.getCheckedRadioButtonId() == R.id.radio3){
			...
			jawaban.setText("The Answer: Crazy");
		} else {
	...
	public void koreksi2(){
		if(pilihan2.getCheckedRadioButtonId() == R.id.radio9){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban2.setText("The Answer: I am too");
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
	...
	public void koreksi3(){
		...
		if(inputJawaban.equals(jawabanUser)){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban3.setText("The Answer: durian");			
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
