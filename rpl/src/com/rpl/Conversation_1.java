...
public class Conversation_1 extends Activity implements OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.conversation_1);
	...
	public void koreksi(){
		if(pilihan.getCheckedRadioButtonId() == R.id.radio2){
			...
			jawaban.setText("The Answer: Bakso");
		} else {
	...
	public void koreksi2(){
		if(pilihan2.getCheckedRadioButtonId() == R.id.radio9){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban2.setText("The Answer: So do I");
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
	...
	public void koreksi3(){
		...
		if(inputJawaban.equals(jawabanUser)){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban3.setText("The Answer:like");			
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
