...
public class Tab_lat_conver extends Activity implements
OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tab_lat_conver);
	...
	private void kosongkan(){
		pilihan.clearCheck();
		pilihan2.clearCheck();
		pilihan3.setText(null);
		pilihan4.clearCheck();
		pilihan5.setText(null);
		pilihan6.clearCheck();
		pilihan7.setText(null);
		pilihan8.clearCheck();
		pilihan9.clearCheck();
