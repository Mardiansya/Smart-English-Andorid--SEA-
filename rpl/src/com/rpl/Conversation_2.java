...
public class Conversation_2 extends Activity implements OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.conversation_2);
	...
	private void playSound(int arg) {
		if (arg == 1) {
			...
			player = MediaPlayer.create(this, R.raw.c1);
		}
	...
	public void koreksi(){
		if(pilihan.getCheckedRadioButtonId() == R.id.radio3){
			...
			jawaban.setText("The Answer: Borrow a pen");
		} else {
	...
	public void koreksi2(){
		if(pilihan2.getCheckedRadioButtonId() == R.id.radio5){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban2.setText("The Answer: Of Course");
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
	...
	public void koreksi3(){
		...
		if(inputJawaban.equals(jawabanUser)){
			Toast.makeText(this, "Jawaban Benar", Toast.LENGTH_SHORT).show();
			jawaban3.setText("The Answer: pen");			
		} else {
			Toast.makeText(this, "Jawaban salah", Toast.LENGTH_SHORT).show();
